...
func (s *UserService) GetAllUsers() ([]dto.GetUserResponse, error) {

	return s.repo.GetAllUsers()
}
func (s *UserService) GetUserById(id int) (*dto.GetProfileResponse, error) {
	user, err := s.repo.GetUserById(id)
	if err != nil {
		return nil, err
	}
	resp := dto.FromUserToProfile(user)
	return resp, nil
}
func (s *UserService) DeleteUserById(id int) (*dto.GetUserResponse, error) {

	return s.repo.DeleteUserById(id)
}
func (s *UserService) UpdateUserById(input *dto.GetUserResponse) (*dto.GetUserResponse, error) {
